...
1️⃣ PAGE 1: OVERVIEW & KEY DRIVERS (Overview.hr.png)
...
2️⃣ PAGE 2: PERFORMANCE & CAREER DYNAMICS (Performance.hr.png)
📊 Visual Breakdown & Insights:
...
3️⃣ PAGE 3: COMPENSATION & PAY EQUITY (Compensation.hr.png)
📊 Visual Breakdown & Insights:
...
Critical Finding: In Job Level 1, ~30% of these underpaid top performers have already resigned, representing a severe financial and talent loss for the company.
...
4️⃣ PAGE 4: DIAGNOSTIC REASONS & COMPOUNDING RISK (Reason.hr.png)
📊 Visual Breakdown & Insights:
...
+-----------------------------------+---------------------------------------+------------------------------------------+
| Priority Level                    | Key Trigger / Metric                  | Recommended HR Intervention              |
+-----------------------------------+---------------------------------------+------------------------------------------+
| 🔴 Priority 1: High-Performer Pay | 134 Underpaid Top Performers (30%     | Execute immediate salary adjustments for |
|                                   | Level 1 loss)                         | underpaid rating-4 performers.           |
|                                   |                                       |                                          |
| 🔴 Priority 2: Early-Career Hold  | 0-2 Years Experience (29.82% Exit) &  | Restructure Job Level 1 compensation and |
|                                   | Sales Rep Low Pay                     | create clear 12-month promotion paths.   |
|                                   |                                       |                                          |
| 🟡 Priority 3: Burnout Capping    | Work-Life Balance <3.0 & Travel/      | Cap overtime, restrict travel cycles, and|
|                                   | Overtime Multiplier (46%-75% Risk)    | mandate remote options for >10km commuters|
|                                   |                                       |                                          |
| 🟢 Priority 4: Transition Anchor  | New Manager + Recent Promotion Risk   | Implement 90-day manager mentorship      |
|                                   |                                       | tracking for newly promoted staff.       |
+-----------------------------------+---------------------------------------+------------------------------------------+
